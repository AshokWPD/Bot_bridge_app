                                                        ...
                                                        Positioned(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children:  [
                                                              Row(
                                                                children:  [
                                                                  Text( "${item.patientName}",style: const TextStyle(color: Color(0xff203298)),overflow: TextOverflow.ellipsis),
                                                                  Text(" ${item.age}, ${item.gender }",style: const TextStyle(color: Colors.grey,fontWeight: FontWeight.w600,fontSize: 13),),
                                                                ],
                                                              ),
                                                              SizedBox(
                                                                height: height * 0.01,
