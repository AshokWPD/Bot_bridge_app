    ...
    setState(() {
      ...
      if (isNumber(query)) {
        ...
        _filteredData = _lastTestDetails
            ?.where((item) =>
                item.mobileNumber.toString().contains(query.toString()))
            .toList();
      } else {
        setState(() {
          usenumber = false;
                    ...
                    Expanded(
                      child: nodata
                          ? SizedBox(
                              ...
                              width: width,
                              child: const Center(
                                  child: Text("No New Request Received")),
                            )
                          : isFetching
                              ? SizedBox(
                                  height: height - 170,
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        Text(
                                                                            "${item.patientName}",
                                                                            style:
                                                                                const TextStyle(color: Color(0xff203298), fontWeight: FontWeight.w600),
                                                                            overflow: TextOverflow.ellipsis),
                                                                        Text(
                                                                          " ${item.age!.replaceAll('Y', "")}, ${item.gender == "Male" ? "Male" : "Female"}",
                                                                          style: const TextStyle(
                                                                              color: Colors.grey,
                                                                              fontWeight: FontWeight.w600,
                                                                              fontSize: 13),
