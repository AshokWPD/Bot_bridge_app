...
if (data != null && data!.lstPatientResponse != null && data!.lstPatientResponse!.isNotEmpty) {
    ...
    return SafeArea(
        child: Scaffold(
          ...
          body: WillPopScope(
            ...
            NavigateController.pagePush(context, PatientDetailsView(screenType: 1, bookingType: widget.bookingType, bookingID: widget.bookID, regdate: widget.regdate,)):
            widget.bookingType=="NR"?
            NavigateController.pagePush(context, PatientDetailsView(screenType: 2, bookingType: widget.bookingType, bookingID: widget.bookID, regdate: widget.regdate,)):
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Positioned(
                                                                          ...
                                                                          child: Column(
                                                                            ...
                                                                            crossAxisAlignment: CrossAxisAlignment.start,
                                                                            children:   [
                                                                              Text(VM.lstPatientResponse![0].lstTestDetails![index].testType ?? "",style: const TextStyle(fontSize: 12),),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                        Positioned(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Positioned(
                                                                                ...
                                                                                Positioned(
                                                                                  ...
                                                                                  child: GestureDetector(
                                                                                    onTap:(){
                                                                                      deleteAlert(context, testDetail.testNo,height,width);
                                                                                    } ,
                                                                                  child: Container(
                                                                         padding: const EdgeInsets.all(2),
                                                                         decoration: const BoxDecoration(
  ...
  deleteAlert( BuildContext context,booktestNo,height,width){
          ...
          child:Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
               const Text("Test Deleted successfully" ,style: TextStyle(color:Colors.black54,fontSize: 18,),maxLines: 2,),
